...
@section('template_title')
    Modifying Chirundu O365 Account
@endsection
        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Chirundu O365</h4>
                        <span>Modfying Chirundu O365</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/chiaccounts') }}">Chirundu O365</a></li>
                        <li class="breadcrumb-item"><a href="#!">Modify Chirundu O365 Account</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Modifying Chirundu O365 Account </h5>
                <div class="card-header-right">
                    <a href="{{ url('/chiaccounts') }}" class="btn btn-round btn-light float-right">
                        <i class="feather icon-chevrons-left" aria-hidden="true"></i>
                        Back to Chirundu O365 List
                    </a>
                </div>
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open([
                        'route' => ['chiaccounts.update', $chiaccount->id],
                        'method' => 'PUT',
                        'role' => 'form',
                        'class' => 'j-forms j-pro ',
                        'id' => 'j-pro',
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="user" id="user">
                                        <option value="{{ $chiaccount->user }}">{{ $chiaccount->user }}</option>
                                        @if ($users)
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::email('email', $chiaccount->email, [
                                        'id' => 'email',
                                        'class' => 'name-group',
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('password', $chiaccount->password, [
                                        'id' => 'password',
                                        'class' => 'name-group',
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('prev_password', $chiaccount->prev_password, [
                                        'id' => 'prev_password',
                                        'class' => 'name-group',
                                        'placeholder' => 'e.g. VeryStrongPassword',
                                    ]) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <input type="text"
                                        value="{{ $chiaccount->last_agent }} @ {{ $chiaccount->updated_at }} " readonly>
                                </div>
                            </div>

            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Create Beira O365 Account</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Adding Beira O365 Account </h5>
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::email('email', null, [
                                        'id' => 'email',
                                        'class' => 'name-group',
                                        'placeholder' => 'e.g. user@gdczamabia.co.zm',
                                    ]) !!}
                                </div>
                                @if ($errors->has('email'))
                                    <span class="help-block">
                    ...
                    <!-- end /.content -->
                    <div class="j-footer">
                        {!! Form::button('Add Account', ['class' => 'btn btn-primary', 'type' => 'submit']) !!}

            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ url('/beiraccounts') }}">Beira O365</a></li>
                        <li class="breadcrumb-item"><a href="#!">Modify Beira O365 Account</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Modifying Beira O365 Account </h5>
                <div class="card-header-right">
                    <a href="{{ url('/beiraccounts') }}" class="btn btn-round btn-light float-right">
                        <i class="feather icon-chevrons-left" aria-hidden="true"></i>
                        Back to Beira O365 List
                    </a>
                </div>
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open([
                        'route' => ['beiraccounts.update', $beiraccount->id],
                        'method' => 'PUT',
                        'role' => 'form',
                        'class' => 'j-forms j-pro ',
                        'id' => 'j-pro',
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <select class="name-group col-sm-12" name="user" id="user">
                                        <option value="{{ $beiraccount->user }}">{{ $beiraccount->user }}</option>
                                        @if ($users)
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('password', $beiraccount->password, [
                                        'id' => 'password',
                                        'class' => 'name-group',
                            ...
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    {!! Form::text('prev_password', $beiraccount->prev_password, [
                                        'id' => 'prev_password',
                                        'class' => 'name-group',
                                        'placeholder' => 'e.g. VeryStrongPassword',
                                    ]) !!}
                        ...
                        <div class="j-row">
                            <div class="j-span6 j-unit">
                                <div class="j-input">
                                    ...
                                    <input type="text"
                                        value="{{ $beiraccount->last_agent }} @ {{ $beiraccount->updated_at }} " readonly>
                                </div>
                            </div>

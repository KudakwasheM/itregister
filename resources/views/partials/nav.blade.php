    ...
    <nav class="pcoded-navbar">
        <div class="pcoded-inner-navbar main-menu">
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li
                    class="pcoded-hasmenu {{ Request::is('iassets', 'desktops', 'desktops/*', 'laptops', 'laptops/*', 'harddrives', 'harddrives/*', 'printers', 'printers/*', 'aothers', 'aothers/*', 'iassets/*', 'iassets/*/edit', 'assetsreport') ? 'pcoded-trigger' : null }}">
                    ...
                    <ul class="pcoded-submenu">
                        <li
                            class=" pcoded-hasmenu {{ Request::is('iassets', 'iassets/*', 'iassets/*/edit', 'iassets/deleted', 'iassets/deleted/*', 'assetsreport') ? 'pcoded-trigger' : null }} {{ Request::is('iassets', 'iassets/*/edit') ? 'active' : null }}">
                            <a href="javascript:void(0)">
                        ...
                        <li
                            class="{{ Request::is('nondesktops', 'nondesktops/*/edit', 'nondesktops/*') ? 'active' : null }}">
                ...
                <li
                    class="pcoded-hasmenu {{ Request::is('sgvpns', 'sgvpns/*', 'sophosvpns', 'sophosvpns/*', 'zamaccounts', 'zamaccounts/*', 'licences', 'licences/*') ? 'pcoded-trigger' : null }}">
                    <a href="javascript:void(0)">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="{{ Request::is('sophosvpns', 'sophosvpns/*/edit', 'sophosvpns/*') ? 'active' : null }}">
                            <a href="{{ url('sophosvpns') }}">
                                <span class="pcoded-mtext">Sophos VPN</span>
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('beitaccounts', 'beitaccounts/*/edit', 'beitaccounts/*') ? 'active' : null }}">
                            <a href="{{ url('beitaccounts') }}">
                                <span class="pcoded-mtext">Beit O365</span>
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('hreaccounts', 'hreaccounts/*/edit', 'hreaccounts/*') ? 'active' : null }}">
                            <a href="{{ url('hreaccounts') }}">
                                <span class="pcoded-mtext">HRE O365</span>
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('chiaccounts', 'chiaccounts/*/edit', 'chiaccounts/*') ? 'active' : null }}">
                            <a href="{{ url('chiaccounts') }}">
                                <span class="pcoded-mtext">Chirundu O365</span>
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('zamaccounts', 'zamaccounts/*/edit', 'zamaccounts/*') ? 'active' : null }}">
                            <a href="{{ url('zamaccounts') }}">
                                <span class="pcoded-mtext">ZAM O365</span>
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('beiraccounts', 'beiraccounts/*/edit', 'beiraccounts/*') ? 'active' : null }}">
                            <a href="{{ url('beiraccounts') }}">
                                <span class="pcoded-mtext">Beira O365</span>
                            </a>
                        </li>
                        <li
                            class="{{ Request::is('drcaccounts', 'drcaccounts/*/edit', 'drcaccounts/*') ? 'active' : null }}">
                            <a href="{{ url('drcaccounts') }}">
                                <span class="pcoded-mtext">DRC O365</span>
                            </a>
                        </li>
                ...
                <li
                    class="pcoded-hasmenu {{ Request::is('noncompliant', 'maintenances', 'maintenances/*', 'backups', 'backups/*', 'wifis', 'wifis/*') ? 'pcoded-trigger' : null }}">
                    <a href="javascript:void(0)">
                    ...
                    <ul class="pcoded-submenu">
                        <li
                            class="{{ Request::is('maintenances', 'maintenances/*/edit', 'maintenances/*') ? 'active' : null }}">
            ...
            <ul class="pcoded-item pcoded-left-item">
                <li
                    class="pcoded-hasmenu {{ Request::is('users', 'users/create', 'users/*', 'users/*/edit') ? 'pcoded-trigger' : null }}">
                    <a href="javascript:void(0)">
                ...
                <li
                    class="pcoded-hasmenu {{ Request::is('departments', 'departments/create', 'departments/*', 'departments/*/edit') ? 'pcoded-trigger' : null }}">
                    <a href="javascript:void(0)">
                ...
                <li
                    class="pcoded-hasmenu {{ Request::is('jobtitles', 'jobtitles/create', 'jobtitles/*', 'jobtitles/*/edit') ? 'pcoded-trigger' : null }}">
                    <a href="javascript:void(0)">
                ...
                <li
                    class="pcoded-hasmenu {{ Request::is('brands', 'brands/create', 'brands/*', 'brands/*/edit') ? 'pcoded-trigger' : null }}">
                    <a href="javascript:void(0)">
            ...
            <ul class="pcoded-item pcoded-left-item">
                <li class="pcoded-hasmenu">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="">
                            <a class="{{ Request::is('roles') || Request::is('permissions') ? 'active' : null }}"
                        ...
                        <li class=" ">
                            <a class="{{ Request::is('active-users') ? 'active' : null }}"
                                href="{{ url('/active-users') }}">
                                <span class="pcoded-mtext">{!! trans('titles.activeUsers') !!}</span>
                            </a>
                        </li>
                        <li class=" ">
                            <a class="{{ Request::is('blocker') ? 'active' : null }}"

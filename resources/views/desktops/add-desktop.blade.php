            ...
            <div class="col-lg-4">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#!">Create Desktop</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="page-body">
        <div class="card">
            <div class="card-header">
                <h5>Adding Desktop - Asset Tag: WASS{{$latestId}} </h5>
            ...
            <div class="card-block">
                <div class="j-wrapper j-wrapper-640">
                    {!! Form::open(array('route' => 'desktops.store', 'method' => 'POST', 'role' => 'form', 'class' => 'j-forms j-pro ', 'id'=>'j-pro', 'enctype'=>'multipart/form-data', 'novalidate'=>"")) !!}
                    ...
                    <input type="hidden" name="assettag" value="WASS{{$latestId}}">
                        ...
                        <div class="j-content">
                            ...
                            <div class="unit">
                                <div class="checkbox-fade fade-in-primary">
                                    <label>
                                        <input type="checkbox" id="has_monitor" name="has_monitor" value="1">
                                        <span class="cr">
                                ...
                                <div class="j-row">
                                    <div class="j-span6 j-unit">
                                        <div class="j-input">
                                            ...
                                            {!! Form::text('monitor_name', NULL, array('id' => 'monitor_name', 'class' => 'name-group', 'placeholder' => 'e.g. Samsung V10Pro')) !!}
                                        </div>
                                    ...
                                    <div class="j-span6 j-unit">
                                        <div class="j-input">
                                            ...
                                            {!! Form::text('monitor_serial', NULL, array('id' => 'monitor_serial', 'class' => 'name-group', 'placeholder' => 'e.g. SMSNG11022313131')) !!}
                                        </div>
                            ...
                            <div class="unit">
                                <div class="checkbox-fade fade-in-primary">
                                    <label>
                                        <input type="checkbox" id="has_keyboard" name="has_keyboard" value="1">
                                        <span class="cr">
                                    <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                ...
                                <div class="j-row">
                                    <div class="j-span6 j-unit">
                                        <div class="j-input">
                                            ...
                                            {!! Form::text('keyboard_name', NULL, array('id' => 'keyboard_name', 'class' => 'name-group', 'placeholder' => 'e.g. HP')) !!}
                                        </div>
                                    ...
                                    <div class="j-span6 j-unit">
                                        <div class="j-input">
                                            ...
                                            {!! Form::text('keyboard_serial', NULL, array('id' => 'keyboard_serial', 'class' => 'name-group', 'placeholder' => 'e.g. HP11022313131')) !!}
                                        </div>
                            ...
                            <div class="unit">
                                <div class="checkbox-fade fade-in-primary">
                                    <label>
                                        <input type="checkbox" id="has_mouse" name="has_mouse" value="1">
                                        <span class="cr">
                                    <i class="cr-icon icofont icofont-ui-check txt-primary"></i>
                                ...
                                <div class="j-row">
                                    <div class="j-span6 j-unit">
                                        <div class="j-input">
                                            ...
                                            {!! Form::text('mouse_name', NULL, array('id' => 'mouse_name', 'class' => 'name-group', 'placeholder' => 'e.g. Logitech')) !!}
                                        </div>
                                    ...
                                    <div class="j-span6 j-unit">
                                        <div class="j-input">
                                            ...
                                            {!! Form::text('mouse_serial', NULL, array('id' => 'mouse_serial', 'class' => 'name-group', 'placeholder' => 'e.g. LT11022313131')) !!}
                                        </div>
                        ...
                        <!-- end /.content -->
                        <div class="j-footer">
                            {!! Form::button('Add Desktop', array('class' => 'btn btn-primary','type' => 'submit' )) !!}
